...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Userdata.ansyahoo'
        db.add_column(u'login_userdata', 'ansyahoo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Userdata.ansyahoo'
        db.delete_column(u'login_userdata', 'ansyahoo')
    ...
    models = {
        ...
        u'login.userdata': {
            ...
            'ansyahoo': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
